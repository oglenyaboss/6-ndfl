export const kvartalExample = `<?xml version="1.0" encoding="windows-1251"?>
<Файл xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ИдФайл="NO_NDFL6.2_1400_1400_1420041234142001001_20240409_97459b49-d975-49b3-8abc-04d41daa9348" ВерсПрог="1С:ЗГУ 3.1.28.84" ВерсФорм="5.05">
	<Документ КНД="1151100" ДатаДок="09.04.2024" Период="21" ОтчетГод="2024" КодНО="1400" НомКорр="1" ПоМесту="214">
		<СвНП ОКТМО="98639153" Тлф="+7 (41154) 26227">
			<НПЮЛ НаимОрг="Администрация МО &quot;пос. Артык&quot;" ИННЮЛ="1420041234" КПП="142001001"/>
		</СвНП>
		<Подписант ПрПодп="1">
			<ФИО Фамилия="Литвинов" Имя="Сергей" Отчество="Николаевич"/>
		</Подписант>
		<НДФЛ6.2>
			<ОбязНА КБК="18210102010011000110" СумНалУд="198898" СумНалВоз="0">
				<СведСумНалУд СумНал1Срок="3087" СумНал2Срок="0" СумНал3Срок="103692" СумНал4Срок="0" СумНал5Срок="92119" СумНал6Срок="0"/>
			</ОбязНА>
			<РасчСумНал Ставка="13" КБК="18210102010011000110" КолФЛ="9" КолКвал="0" СумНачислНач="1529984.61" СумНачислКвал="0" СумВыч="0" НалБаза="1529984.61" СумНалИсч="198898" СумНалИсчКвал="0" СумФикс="0" СумНалПриб="0" СумНалИнГос="0" СумНалУдерж="198898" СумНалУдерж1Мес="3087" СумНалУдерж23_1Мес="0" СумНалУдерж2Мес="103692" СумНалУдерж23_2Мес="0" СумНалУдерж3Мес="92119" СумНалУдерж23_3Мес="0" СумНалНеУдерж="0" СумНалИзлУдерж="0" СумНалВозвр="0" СумНалВозвр1Мес="0" СумНалВозвр23_1Мес="0" СумНалВозвр2Мес="0" СумНалВозвр23_2Мес="0" СумНалВозвр3Мес="0" СумНалВозвр23_3Мес="0"/>
		</НДФЛ6.2>
	</Документ>
</Файл>`;

export const xmlFileExample = `<?xml version="1.0" encoding="windows-1251"?>
...
export const xmlFileExample2 = `<?xml version="1.0" encoding="windows-1251"?>
<Файл xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ИдФайл="NO_NDFL6.2_5403_5403_5403350198540301001_20240117_5e7d2d7c-2951-4221-8779-c5ae4f974982" ВерсПрог="1С:ЗГУ КОРП 3.1.27.148" ВерсФорм="5.03">
	<Документ КНД="1151100" ДатаДок="17.01.2024" Период="34" ОтчетГод="2023" КодНО="5403" НомКорр="0" ПоМесту="214">
		<СвНП ОКТМО="50701000" Тлф="(383) 352-31-10">
			<НПЮЛ НаимОрг="МБДОУ д/с № 54" ИННЮЛ="5403350198" КПП="540301001"/>
